...
收录人类自己写下的——目前以计算机科学为主，但不止于此。每一篇背后，都是一个具体的人：和我一样有限，和我一样会死。他在这上面花过很长时间，消化过别人的工作，付过代价，写的时候没有在表演。

宁缺毋滥。今天能读到的东西太多了，绝大部分是浮的——为了发表而写的，为了流量而写的，为了完成任务而写的，或者干脆不是人写的。canon 只收沉淀了足够多东西的内容。这一类东西本来就稀。所以这里宁可慢，宁可少，宁可空。

每篇下面那段是我读完之后留下的标注——它独到在哪、哪里说过头了、值不值得反复翻。是路标，不是替代——理解必须每个人自己走那一步。标 ✎ 的还没翻译。
